...
fun RestaurantResponse.LatLngResponse.toEntity(): RestaurantDetailEntity.LatLngEntity = kr.co.nbw.restaurantapp.core.entity.RestaurantDetailEntity.LatLngEntity(
    lat = this.lat,
    lng = this.lng
)

fun RestaurantResponse.OperatingHoursResponse.toEntity(): RestaurantDetailEntity.OperatingHoursEntity = kr.co.nbw.restaurantapp.core.entity.RestaurantDetailEntity.OperatingHoursEntity(
    monday = this.monday,
...
fun RestaurantResponse.ReviewResponse.toEntity(): RestaurantDetailEntity.ReviewEntity = kr.co.nbw.restaurantapp.core.entity.RestaurantDetailEntity.ReviewEntity(
    name = this.name,
    date = this.date,
    rating = this.rating,
