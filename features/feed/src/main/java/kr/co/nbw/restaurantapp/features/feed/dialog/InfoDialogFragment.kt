package kr.co.nbw.restaurantapp.features.feed.dialog
...
import kr.co.nbw.restaurantapp.ui_components.components.dialog.Alert
...
@AndroidEntryPoint
class InfoDialogFragment : kr.co.nbw.restaurantapp.core.BaseDialogFragment() {
